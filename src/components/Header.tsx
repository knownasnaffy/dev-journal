    ...
    <nav className="w-full top-0 px-xl py-lg bg-surface-raised border-b border-dashed border-outline-variant">
      <div className="flex justify-between items-center max-w-7xl mx-auto w-full">
        ...
        <div className="hidden md:flex gap-xl items-center">
          ...
          <a href="https://github.com/knownasnaffy" target="_blank" rel="noopener noreferrer">
            <Github/>
          </a>
        </div>
...
const Github = () => (
  <svg
    ...
    className="size-6 hover:scale-110 hover:rotate-[6deg] transition-transform duration-300"
  >
